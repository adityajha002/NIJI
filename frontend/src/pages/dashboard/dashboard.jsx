...
import MiniHeader from "../../components/MiniHead/MiniHead.jsx"
...
function AddProduct({ onClick }) {
  return (
    <div className={style.addProduct} onClick={onClick}>
      ...
      <h2 style={{ fontSize: '15px', fontWeight: '600', marginTop: '8px' }}>Add a Product</h2>
    </div>
  );
}
        ...
        <div className={style.leftColumn}>
          {/* top 70% */}
            <div className={style.leftTop}>
              <MiniHeader style={{ marginBottom : "40px"}} />
              ...
              <div className={style.descriptionRow}>
                ...
                <div className={style.dotsColumn}>
                  <Link to="/"><div className={style.dot1}/></Link>
                  <Link to="/shop-edit"><div className={style.dot2}/></Link>
